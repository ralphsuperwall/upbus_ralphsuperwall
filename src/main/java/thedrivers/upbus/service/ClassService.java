...
public class ClassService {
	...
	//***************************************************************
	// 3.관리자 화면에서 클래스 강사 기간 승인 버튼을 클릭시 DB 내 데이터(CHECK)와 UPDATE 가 수정이 된다. (리턴 : 1.0)
	//***************************************************************
	...
	//***************************************************************
	// 4.관리자 화면에서 클래스 강사 신청 승인 버튼을 클릭시 DB 내 데이터(CHECK)와 UPDATE 가 수정이 된다.
	//***************************************************************
	public int modifyClassAddTeacherFinalCheck(String signupCode, int finalApproveRequestResult) {
		return classMappper.modifyClassAddTeacherFinalCheck(signupCode, finalApproveRequestResult);
	}	

...
public class Member {
	...
	public String getMemberMile() {
		return memberMile;
	}
	public void setMemberMile(String memberMile) {
		this.memberMile = memberMile;
	}
	...
	public String toString() {
		return "Member [memberId=" + memberId + ", memberPw=" + memberPw + ", memberName=" + memberName
				...
				+ ", memberPhone_number=" + memberPhoneNumber + ", memberBirth=" + memberBirth + ", memberMile="
				...
				+ ", memberLogin_history_code=" + memberLoginHistoryCode + ", memberDivision=" + memberDivision + "]";
	}
